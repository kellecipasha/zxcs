...
function CreateEsp(Player)
    ...
    if Player ~= nil and Player:FindFirstChild("Zombie") ~= nil and Player:FindFirstChild("HumanoidRootPart") ~= nil and Player.Humanoid.Health > 0 and Player:FindFirstChild("Head") ~= nil then
